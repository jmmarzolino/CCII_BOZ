...
def getpos(inchr,inpos,inA1,inA2):
    i=0
    for rec in pysamstats.stat_variation_strand(samfile, chrom=inchr, start=inpos-1, end=inpos, truncate=True, fafile="/rhome/dkoenig/shared/GENOMES/BARLEY/2019_Release_Morex_vers2/Barley_Morex_V2_pseudomolecules.fasta"):
        i+=1
