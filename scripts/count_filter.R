...
#SBATCH --ntasks=1
#SBATCH --mem=70G
#SBATCH --job-name='count_filter0'
#SBATCH --output=/rhome/jmarz001/bigdata/CCII_BOZ/scripts/count_filter0.stdout
#SBATCH -p batch
...
write.table(progeny_counts_filtered, file=progeny_counts_filtered0, quote=F ,sep="\t",row.names=F,col.names=F)
